...
enum Status : uint8_t {
  ...
  // bit 2 is set for the first execution of the main loop after the Xbox turns
  // on
...
typedef struct {
  ...
  uint8_t power_timeout2;
  uint8_t power_timeout3;
  uint8_t fan_control_timeout1;
  uint8_t fan_control_timeout2;
  uint8_t audio_clamp_timeout;
  uint8_t boot_response_timeout;
  uint8_t smbus_attempt_counter;
  uint8_t tray_state_timer;
  uint8_t eject_timeout;
  uint8_t dvd_tray_timeout;
} timers_struct;
...
const uint16_t pwm_duty[] = {
  0x0000,
  0x51E *  1, 0x51E *  2, 0x51E *  3, 0x51E *  4, 0x51E *  5, 0x51E *  6, 0x51E *  7, 0x51E *  8, 0x51E *  9, 0x51E * 10, /* 1-10 */
